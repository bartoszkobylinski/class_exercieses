...
class TestPoint3D(unittest.TestCase):
    ...
    def test_calculate_distance_beetwen_two_points(self):
        self.assertEqual(
                        ...
                        self.point.calculate_distance_beetwen_two_points(1, 1, 1))

# 3
# Write a Worker class which will take first_name, last_name, salary, level and gender
# write a _str_ and _init_ methods. Add method to level up and a method to increase salary by some value or
# percentage
